...
const CenterPanel = ({ risk, profit, outcome, isSimulating }: CenterPanelProps) => {
    ...
    <div className="flex flex-col gap-5 h-full animate-slide-up">
      ...
      {isSimulating && (
        <div className="glass-card p-8 flex flex-col items-center justify-center gap-4">
          ...
          <p className="text-sm text-muted-foreground font-medium">AI is analyzing your farm data…</p>
      ...
      {!isSimulating && (
        <>
          ...
          <div className="glass-card p-6 flex items-center justify-center">
            <RiskGauge value={risk} label="Overall Risk" />
          </div>
          ...
          <div className="glass-card p-5 neon-glow-purple">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-muted-foreground uppercase tracking-wider">Future Outcome</span>
            </div>
